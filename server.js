...
function getGenericResponse(level) {
  const responses = {
    'Secundário': 'Essa é uma pergunta interessante! Podes ser mais específico? Por exemplo: "O que são ligações químicas?"',
    'Técnico': 'Essa pergunta está um pouco vaga. Sugerem-se perguntas mais específicas.',
    'Universitário': 'Para uma resposta precisa, podes especificar o tópico?',
    'Avançado': 'Pergunta muito genérica. Especifica mais.'
  };
  return responses[level] || responses['Universitário'];
}
